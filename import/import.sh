...
echo ""
osmconvert temp-olm.o5m --all-to-nodes --max-objects=20000000 --out-o5m >temp.o5m
rm temp-olm.o5m
...
rm temp.o5m
osmosis-0.40.1/bin/osmosis --rx file="temp.osm" enableDateParsing="no" --buffer --s --buffer --wx file="old-olm.osm"
rm temp.osm

osmconvert temp-nextobjects.o5m --all-to-nodes --max-objects=20000000 --out-o5m >temp.o5m
...
rm temp.o5m
osmosis-0.40.1/bin/osmosis --rx file="temp.osm" enableDateParsing="no" --buffer --s --buffer --wx file="old-nextobjects.osm"
rm temp.osm
echo ""
