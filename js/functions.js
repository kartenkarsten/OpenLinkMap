...
function createMap()
{
	...
	ptLayer.events.register('loadstart', map, loadStart);
	ptLayer.events.register('loadend', map, loadEnd);
...
function editPopupContent(content, lat, lon, type, id, moreInfo)
{
	...
	content += '&nbsp;&nbsp;<a href="http://www.openstreetmap.org/edit?editor=id&'+type+'='+id+'" target="_blank">iD</a>'+
